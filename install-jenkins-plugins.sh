...
java -jar jenkins-cli.jar -s http://10.0.1.101:8080/ install-plugin parameterized-trigger \
        ...
        http://updates.jenkins-ci.org/latest/pipeline-multibranch-defaults.hpi \
        ...
        — username dell — password $1 –restart
